...
class DeleteStudent extends StatefulWidget {
  ...
  const DeleteStudent({ Key? key, required this.rcode, required this.rname, required this.rdept, required this.rphone }) : super(key: key);

  @override
  _DeleteStudentState createState() => _DeleteStudentState(rcode, rname, rdept, rphone);
}
...
class _DeleteStudentState extends State<DeleteStudent> {
  ...
  _DeleteStudentState(String rcode, String rname, String rdept, String rphone){
    this.code = rcode;
    this.name = rname;
    this.dept = rdept;
    this.phone = rphone;
  ...
  Future<String> getJSONData() async{
    var url = Uri.parse('http://localhost:8080/Flutter/student_delete_return_flutter.jsp?code=${codeController.text}&name=${nameController.text}&dept=${deptController.text}&phone=${phoneController.text}');
    // print(url);
    // asysc라 await 써준다
