...
class CancelList extends StatefulWidget {
  ...
  const CancelList({ Key? key, required this.rUserID }) : super(key: key);

  @override
  _CancelListState createState() => _CancelListState(rUserID);
}
...
class _CancelListState extends State<CancelList> {
  ...
  _CancelListState(String rUserID){
    this.userID = rUserID;
  }
  ...
  Future<String> getJSONData() async{
    var url = Uri.parse('http://localhost:8080/Flutter_Market/mypage_cancellist_query_flutter.jsp?CustomerId=${userID}');
    // asysc라 await 써준다
