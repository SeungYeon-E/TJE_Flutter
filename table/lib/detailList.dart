...
class DetailList extends StatefulWidget {
  ...
  const DetailList({ Key? key, required this.rcontentList, required this.rcontentImage }) : super(key: key);

  @override
  _DetailListState createState() => _DetailListState(rcontentList, rcontentImage);
}
...
class _DetailListState extends State<DetailList> {
  ...
  _DetailListState(String rcontentList, String rcontentImage){
